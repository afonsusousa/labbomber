...
#define POWERUP_DRAG_MASK   0x10
#define POWERUP_DRAG_SHIFT  4
...
#define GET_POWERUP_DRAG(p) (((p) & POWERUP_DRAG_MASK) >> POWERUP_DRAG_SHIFT)
#define SET_POWERUP_DRAG(p, v) (p) = ((p) & ~POWERUP_DRAG_MASK) | (((v) << POWERUP_DRAG_SHIFT) & POWERUP_DRAG_MASK)
